  ...
  try {
    ...
    await transport.sendMail({
      from:
        ...
        "Führerscheinkontrolle <noreply@example.local>",
      to: options.to,
  ...
  return {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p style="color: #666; font-size: 0.9em;">Diese E-Mail wurde automatisch versendet. Bei Fragen wende dich an den Administrator.</p>
      </div>
    `,
  };
}
  ...
  return {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p style="color: #666; font-size: 0.9em;">Bei Fragen wende dich an den Administrator.</p>
      </div>
    `,
  };
}
