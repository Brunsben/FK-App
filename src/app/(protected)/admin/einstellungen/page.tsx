      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-500">
              Erste E-Mail-Erinnerung an das Mitglied
            </p>
          </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-xs text-gray-500">
              Bei Änderung der Version müssen alle Mitglieder erneut zustimmen
            </p>
          </div>
        </CardContent>
      </Card>

      {/* Sticky Save Bar wenn Änderungen vorhanden */}
      {hasChanges && (
